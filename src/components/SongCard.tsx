          ...
          <div className="p-5 sm:p-6 flex items-start justify-between gap-4">
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-3 flex-wrap">
                <h4 className="text-white/90 text-lg font-medium">
                  {song.title}
                </h4>
                <span className="text-[var(--color-muted)]/40 text-xs font-mono">
                  {song.year}
                </span>
              </div>
              <p className="mt-1 text-[var(--color-muted)]/50 text-xs font-mono tracking-wide">
                {song.album}
              </p>
              {!isOpen && (
