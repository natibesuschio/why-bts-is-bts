...
export const eras: Era[] = [
  {
    ...
    imageAlt: "Dark stage with dramatic spotlight — The School Trilogy era",
    narrative:
    ...
    songs: [
      {
        ...
        evolution:
          "This was the seed. Every era that followed grew from this refusal to stay silent.",
      },
      {
        title: "N.O",
        album: "O!RUL8,2?",
        ...
        whyItMattered:
          "It proved the debut wasn't a gimmick. BTS meant what they said. They weren't going to pivot to safer territory.",
        evolution:
          "The thematic backbone of their early identity — youth as resistance.",
      },
      {
        title: "Boy In Luv",
        ...
        whyItMattered:
          "Their first taste of commercial traction. It showed they could blend their message with accessibility without losing their edge.",
        evolution:
          "A bridge between pure hip-hop roots and the broader emotional palette they'd soon explore.",
      },
    ],
    changedEverything: {
      ...
      image: "https://images.unsplash.com/photo-1501386761578-0a55d12d3e00?w=800&q=80",
    },
  },
  {
    id: "hyyh",
    ...
    imageAlt: "Crowd with warm lights — The Most Beautiful Moment in Life era",
    narrative:
    ...
    songs: [
      {
        ...
        evolution:
          "The moment BTS stopped being a group and became a world.",
      },
      {
        title: "Run",
        ...
        whyItMattered:
          "It deepened the HYYH narrative and established BTS's ability to create musical worlds that demand repeat engagement and interpretation.",
        evolution:
          "Proof that BTS fans weren't just listeners — they were readers, analysts, co-creators of meaning.",
      },
      {
        title: "Fire",
        ...
        whyItMattered:
          "It became an anthem. The energy was infectious, the choreography iconic. It showed BTS could command a stadium.",
        evolution:
          "The bridge between emotional depth and explosive performance — a duality that would become their signature.",
      },
      {
        title: "Young Forever",
        album: "The Most Beautiful Moment in Life: Young Forever",
        ...
        whyItMattered:
          "It became the emotional thesis of the entire era. When performed live, with an ocean of ARMY singing back, it transcended pop music entirely.",
        evolution:
          "The first time BTS made the audience part of the art itself.",
      },
    ],
    changedEverything: {
  ...
  },
  {
    ...
    imageAlt: "Dark artistic silhouettes — Wings era",
    narrative:
    ...
    songs: [
      {
        ...
        evolution:
          "The moment the world realized BTS wasn't just talented — they were visionary.",
      },
      {
        title: "Spring Day",
        ...
        evolution:
          "The proof that BTS could create something timeless. Not a hit — a hymn.",
      },
    ],
  },
  {
    ...
    songs: [
      {
        ...
        evolution:
          "The door that opened the West — not through compromise, but through undeniable quality.",
      },
      {
        title: "Fake Love",
        ...
        evolution:
          "The emotional pivot of the entire series — from seeking love to questioning its authenticity.",
      },
      {
        title: "IDOL",
        ...
        evolution:
          "The thesis resolved. BTS didn't just sing about self-love — they performed it.",
      },
      {
        title: "Epiphany",
        album: "Love Yourself: Answer",
        ...
        whyItMattered:
          "It distilled the entire three-album arc into a single, shattering realization. It's the moment the philosophy became personal.",
        evolution:
          "The emotional resolution that made the Love Yourself series not just an album trilogy, but a complete philosophical work.",
      },
    ],
    changedEverything: {
    ...
    songs: [
      {
        ...
        evolution:
          "A mirror held up to their own past, proving that growth doesn't mean leaving behind who you were.",
      },
      {
        title: "Black Swan",
        ...
        evolution:
          "The deepest BTS had ever gone into artistic self-examination. A song about the fear of creative death, delivered with breathtaking creative vitality.",
      },
      {
        title: "ON",
        album: "Map of the Soul: 7",
        ...
        evolution:
          "The culmination of seven years of growth. From underdogs to kings, still choosing to carry the weight.",
      },
    ],
  },
  {
    ...
    songs: [
      {
        ...
        evolution:
          "Proof that BTS's power was never about spectacle — it was about sincerity.",
      },
      {
        title: "Dynamite",
        ...
        whyItMattered:
          "Their first #1 on the Billboard Hot 100. Their first Grammy nomination. It proved that BTS could dominate the American market on their own terms.",
        evolution:
          "A strategic and emotional masterstroke — proving that sometimes the most radical act is choosing joy.",
      },
    ],
    changedEverything: {
      title: "They reached #1 singing in Korean",
      description:
        "When 'Life Goes On' debuted at #1 on the Billboard Hot 100 entirely in Korean, it shattered a barrier that the industry had insisted was unbreakable. BTS proved that language is not a wall — emotion is universal, and authenticity doesn't need translation.",
    },
  },
  {
    ...
    songs: [
      {
        ...
        evolution:
          "The bridge between Chapter One and Chapter Two. A song that turns an ending into a beginning.",
      },
      {
        title: "For Youth",
        album: "Proof",
        ...
        whyItMattered:
          "It crystallized the relationship between BTS and ARMY into its purest form. Not artist and fan. Family.",
        evolution:
          "The emotional thesis of their entire career: none of this would exist without the people who chose to listen.",
      },
    ],
  },
];
